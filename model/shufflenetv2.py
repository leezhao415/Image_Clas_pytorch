...
model_urls = {
    'shufflenetv2_x0.25': None,
    'shufflenetv2_x0.33': None,
...
def shufflenet_v2_x0_25(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ShuffleNetV2:
    """
    Constructs a ShuffleNetV2 with 0.25x output channels, as described in
    ...
    """
    return _shufflenetv2('shufflenetv2_x0.25', pretrained, progress,
                         [4, 8, 4], [24, 24, 48, 96, 512], **kwargs)

def shufflenet_v2_x0_33(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ShuffleNetV2:
    """
    Constructs a ShuffleNetV2 with 0.33x output channels, as described in
    `"ShuffleNet V2: Practical Guidelines for Efficient CNN Architecture Design"
    <https://arxiv.org/abs/1807.11164>`_.
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _shufflenetv2('shufflenetv2_x0.33', pretrained, progress,
                         [4, 8, 4], [24, 32, 64, 128, 512], **kwargs)
